...
public class TelaCadastroUsuarios extends javax.swing.JFrame {
    ...
    public TelaCadastroUsuarios(Usuario u) {
        ...
        this.usu = u;
        jTextFieldNome.requestFocus();
        jComboBoxTipoUsuario.setSelectedItem(this.usu.getIdtipousuario());
        jPasswordFieldSenha1.setEnabled(false);
        jPasswordFieldSenha2.setEnabled(false);
        jTextFieldNome.setText(this.usu.getNome());
        jTextFieldTelefone.setText(this.usu.getTelefone());
        jTextFieldCelular.setText(this.usu.getCelular());
        jTextFieldUsuario.setText(this.usu.getUsuario());
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addComponent(jComboBoxTipoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                        .addGap(12, 12, 12))))
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if (Senhas.testaSenhasCadastro(pass1, pass2)) {
            ...
            this.usu.setTelefone(jTextFieldTelefone.getText());
            this.usu.setCelular(jTextFieldCelular.getText());
            this.usu.setUsuario(jTextFieldUsuario.getText());
            this.usu.setIdtipousuario((TipoUsuario) jComboBoxTipoUsuario.getSelectedItem());

            try {
                if (this.usu.getIdusuario() == null) {
                    uDAO.inserir(this.usu);
                } else {
                    uDAO.alterar(this.usu, true);
                }
