 ...
 * @author Nasser
 */
public class TelaSelecionaData extends javax.swing.JDialog {

    /**
     * Creates new form TelaSelecionaData
     */
    ...
    public TelaSelecionaData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSelecionaData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaSelecionaData dialog = new TelaSelecionaData(new javax.swing.JFrame(), true);
